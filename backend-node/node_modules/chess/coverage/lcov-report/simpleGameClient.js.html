...
<head>
    <title>Code coverage report for simpleGameClient.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> simpleGameClient.js</h1>
        <div class='clearfix'>
	...
	let
		...
		isFound = (expr, sq) =&gt; {
			return ((typeof expr === 'string' &amp;&amp; sq.file + sq.rank === expr) ||
				(expr &amp;&amp; expr.rank &amp;&amp; <span class="branch-4 cbranch-no" title="branch not covered" >expr.file </span>&amp;&amp;
<span class="branch-5 cbranch-no" title="branch not covered" >					sq.file === expr.file </span>&amp;&amp; <span class="branch-6 cbranch-no" title="branch not covered" >sq.rank === expr.rank)</span>);
		},
		squares = [];
&nbsp;
...
&nbsp;
	<span class="missing-if-branch" title="else path not taken" >E</span>if (squares &amp;&amp; squares.length &gt; 0) {
