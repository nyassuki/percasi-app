...
<head>
    <title>Code coverage report for gameValidation.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> gameValidation.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">387x</span>
<span class="cline-any cline-yes">5181x</span>
<span class="cline-any cline-yes">5181x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5181x</span>
...
&nbsp;
	start (callback) {
		...
		callback = callback || (<span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >(e</span>rr, result) =&gt; <span class="cstat-no" title="statement not covered" >new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span></span>
...
&nbsp;
		<span class="missing-if-branch" title="else path not taken" >E</span>if (this.game) {
...
<span class="cstat-no" title="statement not covered" >		return callback(new Error('game is invalid'));</span>
	}
}
&nbsp;
