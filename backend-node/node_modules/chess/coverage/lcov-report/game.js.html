...
<head>
    <title>Code coverage report for game.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> game.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">458x</span>
<span class="cline-any cline-yes">29312x</span>
<span class="cline-any cline-yes">13012x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
		<span class="missing-if-branch" title="else path not taken" >E</span>if (latest) {
...
&nbsp;
	static load (moveHistory) {
		let
			board = <span class="cstat-no" title="statement not covered" >Board.create(),</span>
			game = <span class="cstat-no" title="statement not covered" >new Game(board),</span>
			i = <span class="cstat-no" title="statement not covered" >0;</span>
&nbsp;
		// handle move and promotion events correctly
<span class="cstat-no" title="statement not covered" >		board.on('move', <span class="fstat-no" title="function not covered" >(e</span>v) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >			addToHistory(game)(ev);</span>
<span class="cstat-no" title="statement not covered" >			if (ev &amp;&amp; ev.capturedPiece) {</span>
<span class="cstat-no" title="statement not covered" >				game.captureHistory.push(ev.capturedPiece);</span>
			}
		});
&nbsp;
<span class="cstat-no" title="statement not covered" >		board.on('promote', denotePromotionInHistory(game));</span>
&nbsp;
		// apply move history
<span class="cstat-no" title="statement not covered" >		for (i = 0; i &lt; moveHistory.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >			board.move(</span>
				board.getSquare(
...
&nbsp;
<span class="cstat-no" title="statement not covered" >		return game;</span>
	}
}
&nbsp;
export class Move {
