...
<head>
    <title>Code coverage report for algebraicGameClient.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> algebraicGameClient.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">94.25% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>164/174</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>96/108</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>160/170</span>
            </div>
...
<span class="cline-any cline-yes">5344x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5344x</span>
<span class="cline-any cline-yes">18055x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4827x</span>
<span class="cline-any cline-yes">4827x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4827x</span>
<span class="cline-any cline-yes">53172x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3364x</span>
<span class="cline-any cline-yes">8944x</span>
<span class="cline-any cline-yes">8944x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8944x</span>
...
<span class="cline-any cline-yes">2672x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2155x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8930x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint sort-imports: 0 */
...
&nbsp;
	if (notation.length &gt; 2) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (captureRegex.test(notation)) {
<span class="cstat-no" title="statement not covered" >			return parseDest;</span>
		}
&nbsp;
...
&nbsp;
	static fromFEN (fen, opts) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if (!fen || typeof fen !== 'string') {
<span class="cstat-no" title="statement not covered" >			throw new Error('FEN must be a non-empty string');</span>
		}
&nbsp;
...
&nbsp;
		...
		let parts = fen.split(' ');
		let active = parts[1] || <span class="branch-1 cbranch-no" title="branch not covered" >'w';</span>
		let baseSide = active === 'b' ? SideType.Black : <span class="branch-1 cbranch-no" title="branch not covered" >SideType.White;</span>
&nbsp;
...
&nbsp;
		...
		game.getCurrentSide = function getCurrentSideAfterFENLoad () {
			return (this.moveHistory.length % 2 === 0) ?
				(whiteFirst ? <span class="branch-0 cbranch-no" title="branch not covered" >SideType.White </span>: SideType.Black) :
				(whiteFirst ? <span class="branch-0 cbranch-no" title="branch not covered" >SideType.Black </span>: SideType.White);
		};
&nbsp;
...
&nbsp;
			if (move) {
				...
				if (promo) {
					switch (promo) {
<span class="branch-0 cbranch-no" title="branch not covered" >						case 'B':</span>
<span class="cstat-no" title="statement not covered" >							p = Piece.createBishop(side);</span>
<span class="cstat-no" title="statement not covered" >							break;</span>
<span class="branch-1 cbranch-no" title="branch not covered" >						case 'N':</span>
<span class="cstat-no" title="statement not covered" >							p = Piece.createKnight(side);</span>
<span class="cstat-no" title="statement not covered" >							break;</span>
<span class="branch-2 cbranch-no" title="branch not covered" >						case 'Q':</span>
<span class="cstat-no" title="statement not covered" >							p = Piece.createQueen(side);</span>
<span class="cstat-no" title="statement not covered" >							break;</span>
						case 'R':
							p = Piece.createRook(side);
							break;
<span class="branch-4 cbranch-no" title="branch not covered" >						default:</span>
<span class="cstat-no" title="statement not covered" >							p = Piece.createPawn(side);</span>
					}
&nbsp;
