...
<head>
    <title>Code coverage report for uciGameClient.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> uciGameClient.js</h1>
        <div class='clearfix'>
...
function parseUCI(uci) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof uci !== 'string') {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.uciMoves || !this.uciMoves[canonical]) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Move is invalid (${uci})`);</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (requiresPromotion &amp;&amp; !promo) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Promotion required for move (${uci})`);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (promo &amp;&amp; !requiresPromotion) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Promotion flag not allowed for move (${uci})`);</span>
    }
&nbsp;
    // make the move
    move = this.game.board.move(`${src.file}${src.rank}`, `${dest.file}${dest.rank}`);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (move) {
...
<span class="cstat-no" title="statement not covered" >            piece = Piece.createBishop(side);</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
<span class="branch-1 cbranch-no" title="branch not covered" >          case 'N':</span>
<span class="cstat-no" title="statement not covered" >            piece = Piece.createKnight(side);</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
          case 'Q':
            piece = Piece.createQueen(side);
            break;
<span class="branch-3 cbranch-no" title="branch not covered" >          case 'R':</span>
<span class="cstat-no" title="statement not covered" >            piece = Piece.createRook(side);</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
<span class="branch-4 cbranch-no" title="branch not covered" >          default:</span>
<span class="cstat-no" title="statement not covered" >            piece = null;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
        }
&nbsp;
